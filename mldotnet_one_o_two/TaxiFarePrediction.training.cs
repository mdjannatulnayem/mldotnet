...
namespace Mldotnet_one_o_two
{
    public partial class TaxiFarePrediction
    {
        public const string RetrainFilePath =  @"C:\Users\nayem\Desktop\mldotnet\mldotnet_one_o_two\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=484,NumberOfIterations=2038,MinimumExampleCountPerLeaf=20,LearningRate=0.202702175069898,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",ExampleWeightColumnName=null,Booster=new GradientBooster.Options(){SubsampleFraction=0.999999776672986,FeatureFraction=0.99999999,L1Regularization=2.91279756792778E-09,L2Regularization=0.999999776672986},MaximumBinCountPerFeature=182}));
